...
## 버전 1.2.6 (2026년 3월 4일)

### 버그 및 오류 개선 사항

*   **경기번호 계산기**
    *   파일 가져오기 확장자 수정, 양식 수정
    *   데이터 없을 시 빈칸으로 나오게끔 수정

---

## 버전 1.2.5 (2026년 3월 4일)

### 버그 및 오류 개선 사항

*   **경기시간 계산기**
    *   [품새, 겨루기] 파일 가져오기 확장자 수정, 양식 수정

---

## 버전 1.2.4 (2025년 8월 6일)

### 버그 및 오류 개선 사항

*   **경기시간 계산기**
    *   [품새] 자유품새 계산시 '결선'은 무조건 1코트만 계산 로직 수정.

---

## 버전 1.2.3 (2025년 7월 30일)

### 버그 및 오류 개선 사항

*   **품새 소청 계산기**:
    *   우리스포츠 점수 계산 방식 오류 수정 (소수점 4자리 내림 -> 소수점 4자리 반올림).
...
*   **경기번호 계산기**
    *   "-"버튼 수정. 디자인 통일화.
    *   "정렬 옵션" 버튼 추가.
        *   정렬 순서 변경 및 "일정안 정렬" 체크박스 추가.
        *   "일정안 정렬" 클릭 후 계산하기 하면 일정안과 유사하게 데이터 출력.
    *   결과 내 순서 변경 기능 추가.
